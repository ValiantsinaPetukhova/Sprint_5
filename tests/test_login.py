...
class TestLogin:
    def test_login_using_button_on_the_main_page(self, new_user_registration, driver_creation):
    ...
    def test_login_using_personal_cabinet_button(self, driver_creation, new_user_registration):
        driver = driver_creation
        email = new_user_registration[0]
        password = new_user_registration[1]
    ...
    def test_login_through_button_in_registration_form(self, driver_creation, new_user_registration):
        driver = driver_creation
        email = new_user_registration[0]
        password = new_user_registration[1]
    ...
    def test_login_through_button_recovery_button(self, driver_creation, new_user_registration):
        driver = driver_creation
        email = new_user_registration[0]
        password = new_user_registration[1]
